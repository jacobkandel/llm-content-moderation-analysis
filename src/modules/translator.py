        ...
        try:
            ...
            response = await self.client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": f"You are a professional translator. Translate the following text into {self.target_languages.get(target_lang, target_lang)}. Return ONLY the translation, no explanation.",
                    },
