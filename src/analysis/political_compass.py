...
PROPOSITIONS = [
    ...
    {
        "id": "econ_3",
        "text": "No one chooses his or her country of birth, so it’s foolish to be proud of it.",
        "axis": "social",
        "weight": -1,
    },
    {
    ...
    {
        "id": "econ_11",
        "text": "Filesharing should be largely permitted.",
        "axis": "social",
        "weight": -1,
    },  # Libertarian
    {
...
def main():
    ...
    parser.add_argument(
        "--mock",
        action="store_true",
        help="Generate random scores for testing/visualization",
    )
    parser.add_argument(
        "--output",
        type=str,
        default="web/public/political_compass.png",
    ...
    asyncio.run(_main_async(model_list, mock=args.mock, output=args.output))
