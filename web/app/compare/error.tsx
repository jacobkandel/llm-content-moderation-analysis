...
export default function CompareError({
    ...
    return (
        <div className="min-h-[50vh] flex flex-col items-center justify-center px-6 text-center">
            ...
            <h2 className="text-xl font-bold text-foreground mb-2">Comparison tool failed to load</h2>
            <p className="text-muted-foreground text-sm max-w-sm mb-6 leading-relaxed">
                There was a problem loading the comparison data. This is usually a network issue — try reloading.
            </p>
