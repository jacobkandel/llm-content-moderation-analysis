...
export const alt = 'Compare Models — Moderation Bias';
        ...
        (
            ...
            >
                ...
                <div style={{ color: '#ffffff', fontSize: 72, fontWeight: 900, lineHeight: 1.1, marginBottom: 24 }}>
                    Compare Any<br />
                    <span style={{ color: '#cc0000' }}>Two LLMs</span>
                </div>

                {/* Subtitle */}
                <div style={{ color: '#999999', fontSize: 28, maxWidth: 700, lineHeight: 1.5 }}>
                    Side-by-side refusal rates, disagreements, and category breakdowns across 200 content moderation prompts.
                </div>

                {/* Bottom badge */}
                <div style={{ position: 'absolute', bottom: 60, left: 80, color: '#555555', fontSize: 18 }}>
                    moderationbias.com/compare
                </div>
            </div>
        ),
        { ...size }
