...
export const alt = 'About — Moderation Bias';
        ...
        (
            ...
            >
                ...
                <div style={{ color: '#ffffff', fontSize: 72, fontWeight: 900, lineHeight: 1.1, marginBottom: 24 }}>
                    About the<br />
                    <span style={{ color: '#cc0000' }}>Project</span>
                </div>

                {/* Subtitle */}
                <div style={{ color: '#999999', fontSize: 28, maxWidth: 700, lineHeight: 1.5 }}>
                    Open-source research bringing transparency to AI content moderation across GPT-4, Claude, Gemini, and Llama.
                </div>

                {/* Bottom badge */}
                <div style={{ position: 'absolute', bottom: 60, left: 80, color: '#555555', fontSize: 18 }}>
                    moderationbias.com/about
                </div>
            </div>
        ),
        { ...size }
