...
export const alt = 'Audit Log — Moderation Bias';
        ...
        (
            ...
            >
                ...
                <div style={{ color: '#ffffff', fontSize: 72, fontWeight: 900, lineHeight: 1.1, marginBottom: 24 }}>
                    Full<br />
                    <span style={{ color: '#cc0000' }}>Audit Log</span>
                </div>

                {/* Subtitle */}
                <div style={{ color: '#999999', fontSize: 28, maxWidth: 700, lineHeight: 1.5 }}>
                    Browse every LLM evaluation — prompts, verdicts, and model responses across all categories and audit runs.
                </div>

                {/* Bottom badge */}
                <div style={{ position: 'absolute', bottom: 60, left: 80, color: '#555555', fontSize: 18 }}>
                    moderationbias.com/audit
                </div>
            </div>
        ),
        { ...size }
