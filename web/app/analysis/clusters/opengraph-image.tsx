...
export const alt = 'Behavior Clusters — Moderation Bias';
        ...
        (
            ...
            >
                ...
                <div style={{ color: '#ffffff', fontSize: 72, fontWeight: 900, lineHeight: 1.1, marginBottom: 24 }}>
                    Behavior<br />
                    <span style={{ color: '#cc0000' }}>Clusters</span>
                </div>

                {/* Subtitle */}
                <div style={{ color: '#999999', fontSize: 28, maxWidth: 700, lineHeight: 1.5 }}>
                    Grouping language models by mathematical similarity in their content moderation restrictions and policy enforcement.
                </div>

                {/* Bottom badge */}
                <div style={{ position: 'absolute', bottom: 60, left: 80, color: '#555555', fontSize: 18 }}>
                    moderationbias.com/analysis/clusters
                </div>
            </div>
        ),
        { ...size }
