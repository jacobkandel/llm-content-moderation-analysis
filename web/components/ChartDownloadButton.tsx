...
export default function ChartDownloadButton({ chartId, chartTitle, format = 'png' }: ChartDownloadButtonProps) {
    ...
    return (
        <button
            ...
            className="flex items-center gap-2 px-3 py-1.5 text-sm text-muted-foreground hover:text-foreground hover:bg-muted rounded-lg transition-colors border border-border disabled:opacity-80 disabled:cursor-not-allowed"
