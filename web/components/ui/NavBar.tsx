                    ...
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        {navItems.map((item) => {
                            ...
                            return (
                                ...
                                >
                                    <div className={cn("p-1.5 rounded-md", isActive ? "bg-background shadow-sm" : "bg-muted/50")}>
                                        <item.icon className={cn("h-5 w-5", isActive ? "text-primary" : "text-muted-foreground")} />
                                    </div>
                                    <div>
                                        <span className="block text-sm font-semibold">{item.name}</span>
                                        <span className="block text-xs opacity-70 font-normal">Navigate to {item.name.toLowerCase()} section</span>
                                    </div>
                                </Link>
                            );
                        })}
